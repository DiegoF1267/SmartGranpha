...
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <asp:Repeater ID="Repetidor" runat="server">
        ...
        <a href="Opciones.aspx?Id=<%# DataBinder.Eval(Container.DataItem, "Id")%>" class="btn btn-primary"> <img class="card-img-top" src="<%# DataBinder.Eval(Container.DataItem, "UrlImagen") %>" alt="Card image cap" height="250" width="260"></a>
        <div class="card-body">
